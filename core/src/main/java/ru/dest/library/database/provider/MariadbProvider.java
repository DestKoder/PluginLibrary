...
public class MariadbProvider extends ConnectionProvider{

    private final String url, user, pass;

    public MariadbProvider(ConnectionProperties props) throws Exception {
        super(props);
        ...
        DatabaseDriver.MARIADB.load();

        this.url = "jdbc:mariadb://"+props.getHost()+":"+props.getPort()+"/"+props.getBase()+"?autoReconnect=true&"+props.getParams();
